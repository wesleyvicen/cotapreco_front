...
interface ContextoAutenticacao { user:Usuario|null; loading:boolean; login:(email:string,password:string)=>Promise<void>; cadastrarFarmacia:(dados:DadosCadastroFarmacia)=>Promise<void>; logout:()=>Promise<void> }
...
export function ProvedorAutenticacao({children}:{children:ReactNode}) {
  ...
  const logout=async()=>{ await encerrarSessaoFarmacia(); setUser(null) }
