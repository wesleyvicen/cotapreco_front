...
export interface LinhaCompraSugerida { quotationItemId:number; ean:string|null; productName:string; allocatedQuantity:number; unitPrice:number; subtotal:number; offerPosition:number; champion:boolean; complement:boolean; manualSelection:boolean; stockOverrideNote:string|null; supplierNote:string|null }
