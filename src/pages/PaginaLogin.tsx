...
export default function PaginaLogin(){
  ...
  return <div className="login-page">
    <section className="login-hero">
      <div className="brand light"><div className="brand-mark"><img src="/cotapreco-icon.png" alt=""/></div><div><strong>CotaPreço</strong><span>Compras inteligentes</span></div></div>
