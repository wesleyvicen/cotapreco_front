/* Fica em arquivo próprio e é carregado sob demanda porque é o único lugar que usa recharts.
   Junto com a lista, a rota de cotações baixava a biblioteca de gráficos inteira só para
   mostrar uma tabela, embora comparar exija selecionar duas cotações já com pedido gerado. */
import { AlertTriangle, ArrowDown, ArrowLeft, ArrowUp, CheckCircle2, CircleDollarSign, Download, Search, ShoppingCart, SlidersHorizontal, Trophy } from 'lucide-react'
import { useEffect, useMemo, useState, type ReactNode } from 'react'
import { Bar, BarChart, CartesianGrid, Cell, Legend, Line, LineChart, ReferenceLine, ResponsiveContainer, Tooltip, XAxis, YAxis } from 'recharts'
import { api, money } from '../api'
import { EstadoVazio, AvisoErro, Carregando } from '../components/ComponentesUI'
import type { ComparativoCompra, PontoHistoricoCompra, ProdutoHistoricoCompra, ResumoCotacao, SituacaoPrecoCompra } from '../types'
...
export default function ComparativoCotacoes({cotacoes,listaCarregando,aoVoltar}:{cotacoes:ResumoCotacao[];listaCarregando:boolean;aoVoltar:()=>void}){
